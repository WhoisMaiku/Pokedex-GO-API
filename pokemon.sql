-- CREATE TABLE pokemon (id INTEGER PRIMARY KEY, number INTEGER NOT NULL, name TEXT NOT NULL);

/* INSERT INTO pokemon (number, name) VALUES
...
(016, 'Pidgy'), (017, 'Pidgeotto'), (018, 'Pidgeot'), (019, 'Rattata'), (020, 'Raticate'),
